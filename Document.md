...
> 当radix介于2-36之间时，将string解析为radix进制的整数返回；  
...
document.write(parseInt("16") + "<br />") 
document.write(parseInt("0x10") + "<br />") 
document.write(parseInt("036") + "<br />") 
document.write(parseInt("19",2) + "<br />") 
document.write(parseInt("11",24) + "<br />") 
document.write(parseInt("0x10",8) + "<br />") 
document.write(parseInt("28 45 69",10) + "<br />") 
document.write(parseInt("He was 40") + "<br />")
</script>
</body>
</html>
结果依次为:16, 16, 36, 1, 25, 0, 28, NaN
```
 
## 三、springmvc与resteasy  
### 依赖注入：
...
<font color = "green">pwd = /data, 即当前所在路径</font>    
> CH-yfy@Yuans-iMac ~$ cd data/    
<font color = "green">pwd = CH-yfy@Yuans-iMac/data, 即当前所在路径</font>  
> ps -ef | grep <进程名> 
...
(2)用字母字符表示权限：     
`owner=u, groups=g, others=o, all(全部用户)=a`    
`+(添加权限)， -(减少权限)`      
已知文件的权限为”-rwxrwxrwx"   
```java
//要删除所有用户的可执行权限时
