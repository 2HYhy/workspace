 ...
 * @date 2017/12/18
 */
//等价于<url-pattern>, 属性value属性UrlPatterns不能同时使用,否则会导致程序无法正常启动
...
public class Servlet2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("uri="+uri);
        out.write("clientAddress="+clientAddress);
        out.println("clientHost="+clientHost);
        out.println("serverAddress="+serverAddress);
        out.println("serverHost="+serverHost);
